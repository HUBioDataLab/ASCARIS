...
opts = detectImportOptions('DMS_benchmark_modeling/training_uptodate_full_pdb_imputed_wo6genesLabelled.txt');
...
T_full_DMS_train_raw = readtable('DMS_benchmark_modeling/training_uptodate_full_pdb_imputed_wo6genesLabelled.txt',opts);
...
T_full_DMS_test_brca1_raw = readtable('DMS_benchmark_modeling/test_featurevector_brca1.txt',opts);
...
T_full_DMS_test_calm1_raw = readtable('DMS_benchmark_modeling/test_featurevector_calm1.txt',opts);
...
T_full_DMS_test_hras_raw = readtable('DMS_benchmark_modeling/test_featurevector_hras.txt',opts);
...
T_full_DMS_test_p53_raw = readtable('DMS_benchmark_modeling/test_featurevector_p53.txt',opts);
...
T_full_DMS_test_pten_raw = readtable('DMS_benchmark_modeling/test_featurevector_pten.txt',opts);
...
save DMS_benchmark_modeling/Mdl_full_cval_DMS.mat Mdl_full_cval_DMS 
save DMS_benchmark_modeling/Mdl_full_test_DMS.mat Mdl_full_test_DMS
save DMS_benchmark_modeling/Perf_tables_DMS.mat Perf_table_DMS_cval Perf_table_DMS_test
